...
const Contact = () => {
  ...
  return (
    <>
      <div className="justify-center grid grid-cols-1 md:grid-cols-3 gap-4 w-[100%] mt-5">
        <div className="shadow-lg md:col-span-2 shadow-gray-900 justify-center content-center flex border-solid border-2 border-[#14261D] rounded-lg bg-black/90 p-3 text-center h-auto">
          <iframe
        ...
        <div className="shadow-lg md:col-span-1 shadow-gray-900 border-solid border-2 border-[#14261D] rounded-lg bg-black/90 p-3">
